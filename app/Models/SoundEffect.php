...
class SoundEffect extends Model
{
    ...
    {
        // foreignPivotKey   = sound_effect_id
        // relatedPivotKey   = tag_id  (bukan sound_tag_id)
        return $this->belongsToMany(SoundTag::class, 'sound_effect_tag', 'sound_effect_id', 'tag_id');
    }
