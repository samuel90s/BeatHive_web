...
@section('subheading','Perbarui pertanyaan & jawaban.')
    ...
    <div class="card-body">
      ...
      <form method="POST" action="{{ route('faqs.update', $faq) }}">
          ...
          <div class="col-lg-4">
            <div class="mb-3">
              ...
              <select name="faq_category_id" class="form-select">
                ...
                @foreach($categories as $c)
                  <option value="{{ $c->id }}" @selected(old('faq_category_id', $faq->faq_category_id)==$c->id)>{{ $c->name }}</option>
                @endforeach
              </select>
            ...
            <div class="mb-3">
              ...
              <input type="number" name="order_column" class="form-control"
                     value="{{ old('order_column', $faq->order_column) }}" min="0">
        ...
        <div class="d-flex justify-content-end gap-2 mt-3">
          <a href="{{ route('faqs.index') }}" class="btn btn-outline-secondary">Back</a>
